...
const _FormatName = "NSFNSFE"

var _FormatIndex = [...]uint8{0, 3, 7}

const _FormatLowerName = "nsfnsfe"
...
var _FormatValues = []Format{FormatNSF, FormatNSFE}

var _FormatNameToValueMap = map[string]Format{
	_FormatName[0:3]:      FormatNSF,
	_FormatLowerName[0:3]: FormatNSF,
	_FormatName[3:7]:      FormatNSFE,
	_FormatLowerName[3:7]: FormatNSFE,
}
